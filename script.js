...
const translations = {
  en: {
    ...
    'hero.subtitle': 'B2B deep cleaning and sanitization for industrial environments. We deliver compliance-ready, eco-conscious results that look, feel, and test cleaner.',
    ...
    'about.desc': 'We specialize in professional B2B cleaning and sanitation that meets rigorous industry standards. Our teams are trained for sensitive environments—from poultry farms to municipal waste sites—delivering measurable disinfection, residue removal, and odor control.',
    ...
    'services.s1.title': 'Deep Sanitization & Disinfection',
    'services.s1.desc': 'Hospital-grade disinfection and ATP-tested sanitation for high-risk zones.',
    'services.s2.title': 'Industrial Degreasing & Residue Removal',
    'services.s2.desc': 'Heavy-duty degreasers and foam cleaning for stubborn build-up and oils.',
    'services.s3.title': 'Odor Control & Deodorization',
    'services.s3.desc': 'Neutralization programs targeting bacterial and organic odor sources.',
    'services.s4.title': 'Waste Removal & Remediation',
    'services.s4.desc': 'Safe handling, sorting, and pre-treatment aligned with regulations.',
    'services.s5.title': 'Emergency Outbreak Cleaning',
    'services.s5.desc': 'Rapid containment and disinfection protocols for critical events.',
    'sectors.title': 'Industries We <span class="accent">Serve</span>',
    'sectors.s1.title': 'Poultry Farms',
    'sectors.s1.desc': 'Biosecurity-first programs to control pathogens and cross-contamination.',
    'sectors.s2.title': 'Olive-oil Presses',
    'sectors.s2.desc': 'Residue and oil removal while protecting food-grade environments.',
    'sectors.s3.title': 'Hotels',
    'sectors.s3.desc': 'Back-of-house deep cleaning and front-of-house disinfection schedules.',
    'sectors.s4.title': 'Municipal Waste Sites',
    'sectors.s4.desc': 'Odor suppression and decontamination for high-load facilities.',
    ...
    'why.b1': '<strong>No-trace cleaning</strong> — finish that looks pristine and tests even better.',
  ...
  fr: {
    'meta.title': 'Zero Trace — Nettoyage et désinfection B2B',
    ...
    'services.s4.title': 'Enlèvement des déchets', 'services.s4.desc': 'Tri, manipulation sécurisée et prétraitement.',
    ...
    'faq.a1': 'Nous accompagnons les élevages avicoles, huileries, hôtels et sites de déchets municipaux.',
    'faq.q2': 'Intervenez-vous en urgence ?',
    'faq.a2': 'Oui, mobilisation rapide avec protocoles de confinement et de désinfection.',
  ...
  es: {
    ...
    'meta.description': 'Zero Trace ofrece limpieza profunda B2B, desinfección, control de olores y saneamiento ecológico para sectores industriales.',
    ...
    'hero.subtitle': 'Limpieza y desinfección B2B para entornos industriales. Resultados ecológicos y conformes.',
    ...
    'about.title': 'Sobre <span class="accent">Zero Trace</span>', 'about.desc': 'Especialistas en limpieza B2B con estándares rigurosos.', 'about.point1': 'Métodos ecológicos', 'about.point2': 'Protocolos y reportes', 'about.point3': 'Equipo industrial y EPP', 'about.point4': 'Despliegue rápido',
    'services.title': 'Servicios <span class="accent">clave</span>', 'services.intro': 'Programas fiables para la industria.',
    'services.s1.title': 'Desinfección profunda', 'services.s1.desc': 'Grado hospitalario y pruebas ATP.',
    'services.s2.title': 'Desengrase industrial', 'services.s2.desc': 'Desengrasantes potentes y espuma.',
    'services.s3.title': 'Control de olores', 'services.s3.desc': 'Neutralización de fuentes bacterianas y orgánicas.',
    'services.s4.title': 'Gestión de residuos', 'services.s4.desc': 'Manejo seguro y pretratamiento.',
    'services.s5.title': 'Emergencias sanitarias', 'services.s5.desc': 'Contención y desinfección rápida.',
    'sectors.title': 'Sectores que <span class="accent">atendemos</span>', 'sectors.s1.title': 'Granjas avícolas', 'sectors.s1.desc': 'Biosiguridad y control.', 'sectors.s2.title': 'Almazaras', 'sectors.s2.desc': 'Eliminación de residuos y aceites.', 'sectors.s3.title': 'Hoteles', 'sectors.s3.desc': 'Limpieza y desinfección.', 'sectors.s4.title': 'Residuos municipales', 'sectors.s4.desc': 'Supresión de olores y descontaminación.',
    ...
    'faq.a1': 'Apoyamos granjas avícolas, almazaras, hoteles y residuos municipales.',
    'faq.q2': '¿Ofrecen limpieza de emergencia?',
    'faq.a2': 'Sí. Movilización rápida con protocolos de contención y desinfección.',
  ...
  de: {
    ...
    'meta.description': 'Zero Trace bietet professionelle B2B-Tiefenreinigung, Desinfektion, Geruchskontrolle und umweltbewusste Sanitisierung für industrielle Sektoren.',
    ...
    'hero.subtitle': 'B2B-Reinigung und Desinfektion für industrielle Umgebungen. Umweltbewusst und konform.',
    ...
    'about.title': 'Über <span class="accent">Zero Trace</span>', 'about.desc': 'Spezialisiert auf professionelle B2B-Reinigung mit strengen Standards.', 'about.point1': 'Umweltfreundliche Methoden', 'about.point2': 'Konforme Protokolle', 'about.point3': 'Industrieausrüstung & PSA', 'about.point4': 'Schneller Einsatz',
    'services.title': 'Kern-<span class="accent">Leistungen</span>', 'services.intro': 'Zuverlässige Programme für die Industrie.',
    'services.s1.title': 'Tiefen-Desinfektion', 'services.s1.desc': 'Krankenhausstandard & ATP-Test.',
    'services.s2.title': 'Industrielles Entfetten', 'services.s2.desc': 'Leistungsstarke Reiniger & Schaum.',
    'services.s3.title': 'Geruchskontrolle', 'services.s3.desc': 'Neutralisierung organischer Quellen.',
    'services.s4.title': 'Abfallbeseitigung', 'services.s4.desc': 'Sichere Handhabung & Vorbehandlung.',
    'services.s5.title': 'Notfallreinigung', 'services.s5.desc': 'Schnelle Eindämmung & Desinfektion.',
    'sectors.title': 'Branchen, die wir <span class="accent">bedienen</span>', 'sectors.s1.title': 'Geflügelfarmen', 'sectors.s1.desc': 'Biosicherheit und Kontrolle.', 'sectors.s2.title': 'Olivenölpressen', 'sectors.s2.desc': 'Entfernung von Rückständen und Ölen.', 'sectors.s3.title': 'Hotels', 'sectors.s3.desc': 'Tiefenreinigung & Desinfektion.', 'sectors.s4.title': 'Kommunale Abfallplätze', 'sectors.s4.desc': 'Geruchsunterdrückung & Dekontamination.',
    ...
    'faq.a1': 'Wir unterstützen Geflügelfarmen, Olivenölpressen, Hotels und kommunale Abfallplätze.',
    'faq.q2': 'Bieten Sie Notfallreinigung an?',
    'faq.a2': 'Ja, schnelle Eindämmung und Desinfektionsprotokolle.',
    'faq.q3': 'Wie fordern wir ein Angebot an?',
    'faq.a3': 'Über das Formular oder an contact@zerotrace.tn. Antwort in 1 Werktag.'
  },
  ar: {
    'meta.title': 'زيرو تريس — تنظيف وتعقيم للشركات',
    ...
    'faq.a1': 'نخدم مزارع الدواجن، معاصر الزيتون، الفنادق ومواقع النفايات البلدية.',
    'faq.q2': 'هل تقدمون تنظيفاً طارئاً؟',
    'faq.a2': 'نعم، تعبئة سريعة مع بروتوكولات احتواء وتعقيم.',
